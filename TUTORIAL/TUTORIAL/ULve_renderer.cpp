...
namespace lve {
    ...
    LveRenderer::LveRenderer(ULveWindow &window, ULveDevice &device) : lveWindow(window), lveDevice(device), currentFrameIndex{0}, isFrameStarted{false} {
        recreateSwapChain();
    ...
    void LveRenderer::createCommandBuffers() {
        commandBuffers.resize(ULveSwapChain::MAX_FRAMES_IN_FLIGHT);
    ...
    void LveRenderer::recreateSwapChain() {
        ...
        if (lveSwapChain != nullptr) {
            std::shared_ptr<ULveSwapChain> oldSwapChain = std::move(lveSwapChain);
            lveSwapChain = std::make_unique<ULveSwapChain>(lveDevice, extent, oldSwapChain);
    ...
    void LveRenderer::endFrame()
    {
        ...
        currentFrameIndex = (currentFrameIndex + 1) % ULveSwapChain::MAX_FRAMES_IN_FLIGHT;
    }
